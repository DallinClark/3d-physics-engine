#include "../../../include/physics/collisions/collisions.h"
...
bool Collisions::collide(std::shared_ptr<RigidBody> bodyA, std::shared_ptr<RigidBody> bodyB, glm::vec3& normal, float& depth) {
    ...
    if (shapeTypeA == ShapeType::Cube || shapeTypeA == ShapeType::Tetrahedron || shapeTypeA == ShapeType::Diamond) {
        if (shapeTypeB == ShapeType::Cube || shapeTypeB == ShapeType::Tetrahedron || shapeTypeB == ShapeType::Diamond) {
...
void Collisions::findContactPoints(
    ...
    int& outContactCount) {
    if (bodyA->shapeType == ShapeType::Cube || bodyA->shapeType == ShapeType::Tetrahedron || bodyA->shapeType == ShapeType::Diamond) {
        if (bodyB->shapeType == ShapeType::Cube || bodyB->shapeType == ShapeType::Tetrahedron || bodyB->shapeType == ShapeType::Diamond) {
